  ...
  #    python3 ./scripts/clinical_main.py  \
...
#    ./data/processed/countData.txt
  ...
  Rscript ./scripts/combat_seq_correct.R \
    ./data/processed/kept_data.txt \
    ./data/processed/ComBat_corrected_counts.txt
  
  Rscript ./scripts/normalize_counts_tmm.R \
    ./data/processed/ComBat_corrected_counts.txt \
  ...
  # ================
  Rscript ./scripts/merge_clinical_mirna.R \
  ...
  # ================
  Rscript ./scripts/plot_pca_miRNA.R \
    ./data/processed/tmm_normalized_data.csv \
    ./reports/figures/pca_plot.png
  
  Rscript ./scripts/correlation_analysis.R \
    --input ./data/processed/merged_clinical_mirna.csv \
    --output_dir ./reports/tables/ \
    --prefix mirna_corr
  
  python3 ./scripts/plot_correlation_heatmap.py \
  ...
  Rscript ./scripts/volcano_combined_plots.R \
  ...
  Rscript ./scripts/filter_limma_results.R \
    ./reports/tables/ \
    ./reports/tables/limma_DEGs_Group1vsGroup2.csv \
    ./reports/tables/limma_DEGs_Group2vsGroup0.csv \
    ./reports/tables/limma_DEGs_Group1vsGroup0.csv
  ...
  # ================
  Rscript ./scripts/lasso_multiclass_miRNA.R \
    ./data/processed/merged_clinical_mirna.csv \
    ./reports/tables/
  
  Rscript ./scripts/RF_feature_selection.R \
    ./data/processed/merged_clinical_mirna.csv \
    ./reports/figures/ \
    ./reports/tables/
  
  python3 ./scripts/venn_compare_feature_sets.py
